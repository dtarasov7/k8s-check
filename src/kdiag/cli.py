...
def _parser():
    parser = argparse.ArgumentParser(prog="kdiag", description="Разовый deterministic snapshot Kubernetes/RED OS без LLM")
...
def main(argv=None):
    ...
    try:
        if arguments.command == "snapshot":
            ...
            collection_dir, status = run_snapshot(arguments.inventory, arguments.group, arguments.output_dir, config)
